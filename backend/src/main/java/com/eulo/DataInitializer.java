...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        // --- Users ---
        User alex = new User("u1", "Alex Rivera", "alex.rivera@school.edu", pw,
        ...
        User sarah = new User("u2", "Sarah Chen", "sarah.chen@school.edu", pw,
        ...
        User marcus = new User("u3", "Marcus Johnson", "marcus.johnson@school.edu", pw,
        ...
        User emily = new User("u4", "Emily Davis", "emily.davis@school.edu", pw,
        ...
        User david = new User("u5", "David Kim", "david.kim@school.edu", pw,
                "teacher", "Information Technology",
        ...
        User jessica = new User("u6", "Jessica Wong", "jessica.wong@school.edu", pw,
                "teacher", "Information Technology", null,
                "Frontend basics: HTML, CSS, JavaScript. Great for beginners!",
                List.of("Web Development"), 7);

        User jenny = new User("u7", "Jenny Wilson", "jenny.wilson@school.edu", pw,
